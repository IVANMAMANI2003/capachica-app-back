...
describe('PaquetesTuristicosService', () => {
  ...
  describe('create', () => {
    ...
    it('should create a paquete turistico successfully', async () => {
      ...
      const mockPaquete = {
        id: 1,
        ...createDto,
        emprendimiento: mockEmprendimiento,
        servicios: [],
      };
      ...
      mockPrismaService.paqueteTuristico.findUnique.mockResolvedValue({
        id: 1,
        ...createDto,
        emprendimiento: mockEmprendimiento,
        servicios: [],
  ...
  describe('update', () => {
    ...
    it('should update a paquete turistico successfully', async () => {
      ...
      mockPrismaService.imageable.create.mockResolvedValue({ id: 1 });
      mockPrismaService.paqueteTuristico.findUnique.mockResolvedValueOnce({
        id: 1,
        ...updateDto,
        emprendimiento: {},
        servicios: [],
  ...
  describe('addFavorite', () => {
    ...
    it('should throw BadRequestException if paquete is already in favorites', async () => {
      ...
      await expect(service.addFavorite(1, 1)).rejects.toThrow(BadRequestException);
    });
  });
  ...
  describe('removeFavorite', () => {
    ...
    it('should throw BadRequestException if paquete is not in favorites', async () => {
      ...
      await expect(service.removeFavorite(1, 1)).rejects.toThrow(BadRequestException);
    });
  });
  ...
  describe('createDisponibilidad', () => {
    const createDisponibilidadDto: CreateDisponibilidadDto = {
  ...
  describe('updateDisponibilidad', () => {
    const updateDisponibilidadDto: UpdateDisponibilidadDto = {
      fechaInicio: '2024-03-01',
      fechaFin: '2024-03-31',
      cuposDisponibles: 5,
      cuposMaximos: 15,
