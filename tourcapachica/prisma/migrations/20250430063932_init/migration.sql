...
-- AddForeignKey
ALTER TABLE "paquetes_turisticos" ADD CONSTRAINT "paquetes_turisticos_emprendimientoId_fkey" FOREIGN KEY ("emprendimientoId") REFERENCES "emprendimientos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
